...
LightRAW 是一款面向 macOS 和 Windows 的轻量级、非破坏性 RAW 照片编辑器。当前仓库完成了阶段四：在局部调整图层与可组合蒙版之上，加入图层混合、完整历史和 JSON 预设。
...
- `⌘/Ctrl+Z` 撤销、`⇧⌘/Ctrl+Z` 或 `Ctrl+Y` 重做、`\` 前后对比、`E/C/M/P` 切换面板
- WebGL 2 实时预览
...
各阶段的详细边界与验收记录见 [docs/PHASE-1.md](docs/PHASE-1.md)、[docs/PHASE-2.md](docs/PHASE-2.md)、[docs/PHASE-3.md](docs/PHASE-3.md) 与 [docs/PHASE-4.md](docs/PHASE-4.md)。
