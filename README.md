...
- `⌘/Ctrl+Z` 撤销、`⇧⌘/Ctrl+Z` 或 `Ctrl+Y` 重做、`\` 前后对比、`G/E/C/M/P/X` 切换面板、`0–5` 评分
- WebGL 2 实时预览
...
各阶段的详细边界与验收记录见 [docs/PHASE-1.md](docs/PHASE-1.md)、[docs/PHASE-2.md](docs/PHASE-2.md)、[docs/PHASE-3.md](docs/PHASE-3.md)、[docs/PHASE-4.md](docs/PHASE-4.md) 与 [docs/PHASE-5.md](docs/PHASE-5.md)。
